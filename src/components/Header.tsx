          ...
          <nav className="hidden md:flex items-center">
            ...
            {user ? (
              <button
                ...
                className="ml-4 px-3 py-1 border rounded text-gray-700 hover:bg-gray-100"
              >
                Logout
              </button>
            ) : (
              <a href="/login" className="ml-4 px-3 py-1 border rounded text-gray-700 hover:bg-gray-100">
                Login
              </a>
            )}
