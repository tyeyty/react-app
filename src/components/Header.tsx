...
export default function Header() {
  ...
  if (isMobile) {
    return (
      <div className="flex h-[60px] items-center justify-center px-4 py-2 bg-blue-600 text-white relative">
  ...
  return (
    <div className="fixed w-full top-0 left-0 bg-gray-100 border-b border-gray-300 h-[40px] z-50">
      <div className="2xl:w-[1300px] mx-auto">
        <div className="px-4 py-2 flex items-center justify-between text-sm">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="https://www.youtube.com/@dalsaramdotcom" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 256 180"><path fill="#f00" d="M250.346 28.075A32.18 32.18 0 0 0 227.69 5.418C207.824 0 127.87 0 127.87 0S47.912.164 28.046 5.582A32.18 32.18 0 0 0 5.39 28.24c-6.009 35.298-8.34 89.084.165 122.97a32.18 32.18 0 0 0 22.656 22.657c19.866 5.418 99.822 5.418 99.822 5.418s79.955 0 99.82-5.418a32.18 32.18 0 0 0 22.657-22.657c6.338-35.348 8.291-89.1-.164-123.134"/><path fill="#fff" d="m102.421 128.06l66.328-38.418l-66.328-38.418z"/></svg>
            </a>
          </div>
        ...
        {/* Menubar */}      
        <div>
          <a href="/trips" className="text-[12px] font-bold">Trip App</a>
        </div>
      </div>
    </div>
  );
