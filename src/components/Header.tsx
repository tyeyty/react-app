      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            {user ? (
              <div className="flex items-center space-x-2 pl-4 border-l border-gray-200 ml-4">
                <span className="text-xs text-gray-600">
                  <strong>{user.user_metadata?.name || user.email}</strong>님 환영합니다
                </span>
                <Link to="/mypage" className="text-gray-600 hover:text-gray-900 text-xs">
                  Mypage
                </Link>
                <Link to="/messages" className="text-gray-700 hover:text-gray-900 text-xs">
                  쪽지관리
                </Link>
                <button
                  onClick={handleLogout}
                  className="ml-1 px-3 py-1 border rounded text-gray-700 hover:bg-gray-100 text-xs transition-colors"
                >
                  Logout
                </button>
              </div>
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="text-left px-3 py-1 border rounded text-gray-700 hover:bg-gray-100 text-xs w-fit transition-colors"
              >
                Logout
              </button>
            </>
